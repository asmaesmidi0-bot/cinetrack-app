package com.asma.cinetrack.ui.login
...
fun LoginScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(text = "Login", style = MaterialTheme.typography.headlineLarge, color = MaterialTheme.colorScheme.onPrimary)
...
fun LoginScreenPreview() {
    CineTrackTheme {
       // LoginScreen(onLogin = { _, _ -> }, onNavigateToSignUp = {})
    }
}
